...
const _mqttHost = String.fromEnvironment(
  'DESKMATE_MQTT_HOST',
  defaultValue: '',
);
const _mqttPort = int.fromEnvironment(
  'DESKMATE_MQTT_PORT',
  defaultValue: 1883,
);
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  String? _error;
  bool _busy = false;
  bool _autoScreenCyclingEnabled = true;
  ...
  void initState() {
    ...
    final mqttHost = _mqttHost.trim();
    _source = mqttHost.isNotEmpty
        ? MqttStateSource(mqttHost, port: _mqttPort)
