import 'package:deskmate_ui_env/dashboard_view.dart';
...
void main() {
  testWidgets('renders the six product views at 1024x600', (tester) async {
    ...
    expect(find.text('조도'), findsOneWidget);
    expect(find.text('720 ppm', findRichText: true), findsOneWidget);
    expect(find.text('25.3 °C', findRichText: true), findsOneWidget);
    expect(find.text('54.6 %', findRichText: true), findsOneWidget);
    expect(find.text('444 lx', findRichText: true), findsOneWidget);
