...
struct MqttConfig {
    std::string host{"127.0.0.1"};   // Pi 4 local broker; empty environment value disables MQTT
    int port{1883};
...
// Environment: DESKMATE_MQTT_HOST (default 127.0.0.1; empty = disabled),
// DESKMATE_MQTT_PORT (1883), DESKMATE_MQTT_CLIENT_ID.
