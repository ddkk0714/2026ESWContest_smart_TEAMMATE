...
#if DESKMATE_HAS_SCD41
SensirionI2CScd4x scd41;  // library 0.4.0 API: fixed I2C address 0x62
#endif
#if DESKMATE_HAS_BH1750
BH1750 bh1750;
#endif
...
#endif
#if DESKMATE_HAS_SCD41
  scd41.begin(Wire);  // 0.4.0 has no address parameter; kScd41Address (0x62) is the fixed part address
